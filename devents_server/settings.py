"""
Django settings for devents_server project.
...
SECRET_KEY = 'dc676krx(5a5x67_7tkj7qucl9%!x_jr$im^za@dfq+wuc-*5z'
...
ROOT_URLCONF = 'devents_server.urls'

WSGI_APPLICATION = 'devents_server.wsgi.application'
